...
vim.keymap.set('n', '<m-i>', 'i```{python}<cr>```<esc>ko', { desc = '[i]nsert Code chunk' })
vim.keymap.set('n', '<leader>ci', ':split term://ipython<cr>', { desc = '[c]opy code into [i]python' })
